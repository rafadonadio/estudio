<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="AdmCodigos.aspx.cs"
	Inherits="AdmCodigos" %>
					...
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<tr>
							<td colspan="3" class="textblock tahoma11 color_5b5b5b interLine">
								<table align="center">
									<tr>
										<td> <asp:Label ID="lblCod" runat="server" Text="Tipo Código"></asp:Label>
										</td>
										<td colspan="4">
											<asp:DropDownList ID="cboGrupo" runat="server" 
												OnSelectedIndexChanged="cboGrupo_SelectedIndexChanged" AutoPostBack="True">
											</asp:DropDownList>
										</td>
									</tr>
									<tr>
										...
										<td>
											...
											<asp:RequiredFieldValidator ID="rqvCod" runat="server" CssClass="error" Display="Dynamic"
												ErrorMessage="Debe ingresar el código" ValidationGroup="alta" ControlToValidate="txtCodigo">*</asp:RequiredFieldValidator>
										</td>
										<td>
											&nbsp;
										</td>
										...
										<td>
											...
											<asp:RequiredFieldValidator ID="rqvDesc" runat="server" CssClass="error" Display="Dynamic"
												ErrorMessage="Debe ingresar la descripción" ValidationGroup="alta" ControlToValidate="txtDescripcion">*</asp:RequiredFieldValidator>
										</td>
									</tr>
									<tr>
										<td colspan="5">
									...
									<tr>
										<td colspan="5" align="center">
											<asp:ImageButton ID="btnSave" runat="server" OnClick="btnSave_Click" ImageUrl="images/save_button.jpg"
												CausesValidation="true" ValidationGroup="alta" />
										</td>
									</tr>
									<tr>
										<td colspan="5">
						...
						<tr class="allresults_container" align="center">
							<td class="textblock tahoma11 color_5b5b5b" colspan="3">
								<asp:GridView ID="GridView1" align="center" runat="server" AutoGenerateColumns="False"
									DataSourceID="codDataSource" DataKeyNames="Id">
								...
								<asp:ObjectDataSource ID="codDataSource" runat="server" SelectMethod="Code_GetByGroup"
									TypeName="DataAccess" UpdateMethod="Code_Update" DataObjectTypeName="Code"
									DeleteMethod="Code_Delete" InsertMethod="Code_Insert" OnDeleted="codDataSource_Deleted">
									<SelectParameters>
										<asp:ControlParameter ControlID="cboGrupo" PropertyName="SelectedValue" Name="Group" />
									</SelectParameters>
