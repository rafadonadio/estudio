<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ContribEnConstruccion.aspx.cs" Inherits="ContribEnConstruccion" %>
			...
			<tr height="500px">
				...
				<td id="tdBody" valign=top>
					...
					<table cellpadding=0 cellspacing=0 border=0>
						...
						<tr><td colspan=3>&nbsp;</td></tr>
						<tr class="allresults_container"><td class="textblock tahoma11 color_5b5b5b" colspan=3>Esta página se encuentra en desarrollo</td></tr>
					</table>
				</td>
