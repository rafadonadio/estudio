<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="AdmSociedades.aspx.cs"
	Inherits="AdmSociedades" %>
...
<head runat="server">
	<title>Administración de Tipos de Sociedad</title>
				...
				<td id="tdBody" valign="top">
					...
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
							...
							<td class="light_resulttitle floatleft">
								<h1 class="tahoma11 color_5b5b5b">
									Administración de Tipos de Sociedad</h1>
							</td>
							<td>
								...
								<table align=center>
									...
									<tr>
										<td colspan="5" align=center>
											<asp:ImageButton ID="btnSave" runat="server" onclick="btnSave_Click" ImageUrl="images/save_button.jpg"  ValidationGroup="alta"/>
										</td>
									</tr>
									<tr>
										<td colspan="5">&nbsp;
						...
						<tr class="allresults_container" align=center>
							<td class="textblock tahoma11 color_5b5b5b" colspan="3"  align=center>
								...
								<asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="SocietyType_GetAll"
									TypeName="DataAccess" UpdateMethod="SocietyType_Update" DataObjectTypeName="SocietyType"
									DeleteMethod="SocietyType_Delete" InsertMethod="SocietyType_Insert" 
									ondeleted="ObjectDataSource1_Deleted"></asp:ObjectDataSource>
